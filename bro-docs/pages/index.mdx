---
title: The Zero-Boilerplate Node.js Framework
description: Official documentation for bro.js, the zero-config backend framework with file-based routing, Zod validation, and WebSockets.
---
