---
title: CLI Reference
description: Master the bro.js command-line interface to scaffold, manage, and build your backend projects.
---
...
| `bro sdk` | Parses your `routes/` directory and generates the `bro-sdk.js` frontend SDK fetch client. |
